...
public class InterestsPathFactoryTest {
	...
	public void generateAllPaths() throws Exception {
		...
		// assertThat(paths.get(0).getValues()).isEqualTo(new double[] {
		// aModel.getStartShortrate(), 22.012665318695152,
		// 73.53026551399789, 242.99540049413446, 744.8050553245859, 2251.33803863817,
		// 6757.597054620673 });
	}
